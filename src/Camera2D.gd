...
export var global_text_pos : Vector2 = Vector2(0,150)
...
func ready():
	...
	Singleton.global_message.rect_position = global_text_pos
	Singleton.global_message.text = "Test"
...
func zoom_all(zoom_val):
	...
	Singleton.global_message.rect_scale *= zoom_val
func reset_zoom():
	zoom = Vector2(1,1)
	$ModeLabel.rect_scale = Vector2(1,1)
	$HelpLabel.rect_scale = Vector2(1,1)
	Singleton.global_message.rect_scale = Vector2(1,1)
